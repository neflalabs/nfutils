...
NF_VERSION="v2025-10-27T21:44:27-g1009c48"
...
EOF
tmp_file=$(mktemp)
sed "s|v2025-10-27T21:44:27-g1009c48|$NF_VERSION|g; s|https://raw.githubusercontent.com/neflalabs/nfutils/main/nfutils.sh|$NF_REPO_URL|g" "$NF_PATH" > "$tmp_file"
mv "$tmp_file" "$NF_PATH"
