...
NF_VERSION="v2025-12-08T15:18:05Z-g91522e4"
...
EOF
tmp_file=$(mktemp)
sed "s|v2025-12-08T15:18:05Z-g91522e4|$NF_VERSION|g; s|https://raw.githubusercontent.com/neflalabs/nfutils/main/nfutils.sh|$NF_REPO_URL|g" "$NF_PATH" > "$tmp_file"
mv "$tmp_file" "$NF_PATH"
